...
export default function TournamentCard({ tournament, colorIndex = 0 }) {
  return (
    <Link
      to={`/tournaments/${tournament.id}`}
      className={`block rounded-2xl p-5 ${COLORS[colorIndex % COLORS.length]} hover:opacity-90 transition-opacity min-w-[220px]`}
    >
